...
import { Button, Card, CardContent, CreateGroupDialog, LoadingSkeleton, ErrorState } from "@/components";
...
export default function GroupsPage() {
  ...
  if (error) {
    return <ErrorState error={error} title="Error loading groups" onRetry={fetchGroups} />
  }
